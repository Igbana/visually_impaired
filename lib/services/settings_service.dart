...
class SettingsService extends GetxService {
  final setting = Setting(mainColor: "0xFF3A7EF7", mainDarkColor: "0xFF3A7EF7", secondColor: "#FF000000").obs;
  late GetStorage _box;
  var colorr = Color(0xFF3A7EF7);
  ...
  ThemeData getWebLightTheme() {
    ...
    return ThemeData(
        ...
        textTheme: GoogleFonts.getTextTheme(
          ...
          TextTheme(
            titleLarge: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, height: 1.3),
            headlineSmall: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w700, height: 1.3),
            headlineMedium: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w400, height: 1.3),
            displaySmall: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w700,  height: 1.3),
            displayMedium: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w700, height: 1.4),
            displayLarge: TextStyle(fontSize: 28.0, fontWeight: FontWeight.w300, height: 1.4),
            titleSmall: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600,  height: 1.2),
            titleMedium: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w400,  height: 1.2),
            bodyMedium: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600,  height: 1.2),
            bodyLarge: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w400, height: 1.2),
            bodySmall: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w300,  height: 1.2),
          ),
        ));
  }
